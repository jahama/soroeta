...
<?php }?>
<div align="right">
<div style="float:right;padding:0px 5px;width:32px;"><a href="#" class="toolbar" onclick="javascript:bl_submit('admin_team',0);return false;"><span class="icon-32-cancel"></span><?php echo JText::_('BLFA_CLOSE')?></a></div>
...
<?php
		...
		<table style="padding:10px;" class="jsnoborders">
			...
			<tr>
				<td>
					<input type="button" style="cursor:pointer;" value="<?php echo JText::_( 'BLFA_UPLOAD' ); ?>" onclick="javascript:submitbutton('team_apply');" />
				</td>
			</tr>
		</table>
		<?php
