...
<div style="float:right;padding:0px 5px;width:32px;"><a href="#" class="toolbar" onclick="javascript:bl_submit('mplayer_edit',1);return false;"><span class="icon-32-edit"></span><?php echo JText::_('BLFA_EDIT')?></a></div>
